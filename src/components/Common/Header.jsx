...
class Header extends React.Component {
  constructor(props) {
    super(props);
    this.state = { logo: require('./../../images/avshin.jpg') };
  }
              ...
              <div className="row">
                <div className="mt-topbar-left clearfix">
                  <ul className="list-unstyled e-p-bx pull-right">
                    <li>
                      <i className="fa fa-envelope" /> avetisyanshin@mail.ru
                    </li>
                    <li>
              ...
              <div className="container">
                ...
                <div
                  ...
                  <div className="contact-nav">
                    <NavLink to={'#'} className="contact_close" onClick={this.handleQuoteToggle}>
                      ×
                    </NavLink>
